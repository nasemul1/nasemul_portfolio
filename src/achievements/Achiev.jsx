            ...
            <div className="achiev-container">
                <div className="front-end">
                    ...
                    <div className='achiev-box' id="2">
                        <h4>Completed Freecodecamp Responsive Web Design</h4>
                    ...
                    <div className='achiev-box' id="1">
                        <h4>Completed Learn the basics of web - Internet fundamentals</h4>
                ...
                <div className="cp">
                    <h3>Others:</h3>
                    <div className='achiev-box' id="2">
                        <h4>Perticipated CUET IUPC Codestorm 1.0</h4>
                    </div>
                    <div className='achiev-box' id="1">
                        <h4>Perticipated ICPC Dhaka Regional Contest - 2023</h4>
